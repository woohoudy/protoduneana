...
namespace protoana{
  ...
  void hitrmsrawdigits::analyze( const art::Event& evt){//analyze
    ...
    std::vector< float> peakT_0;  std::vector< float> peakT_1;  std::vector< float> peakT_2; std::vector<float> hit_peakTrawb;
    ...
    std::vector<float> rms_0;   std::vector<float> rms_1; std::vector<float> rms_2, rms_raw2;
    ...
    for(size_t i=0; i<NTracks;++i){
      ...
      peakT_0.clear(); peakT_1.clear();  peakT_2.clear(); hit_peakTrawb.clear();
      ...
      rms_0.clear();   rms_1.clear(); rms_2.clear();rms_raw2.clear();
